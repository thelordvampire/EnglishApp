...
package bao.example.englishapp.out_library.ui.circular_progress;
...
//my code
        text = new Text(String.valueOf(gauge.getCurrentValue()).split("\\.")[0] );
//        text = new Text(String.valueOf(gauge.getCurrentValue()));
...
//my code
//        int value = (int)(100 * LEVEL);
//        text.setText(String.valueOf(value));
        
        text.setText(String.valueOf(10 * LEVEL).split("\\.")[0] );
